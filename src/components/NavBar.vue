...
<template>
  ...
  >
    ...
    <ul class="hidden md:flex">
      ...
      <li class="p-5"><a href="#work">Work</a></li>
      <li class="p-5"><a href="#experience">Experience</a></li>
    ...
    <div
      v-if="nav"
      @click="handleNav"
      class="fixed top-0 left-0 bottom-0 w-full bg-black opacity-50 md:hidden ease-in-out duration-500"
    ></div>
    <div
      :class="
        nav
          ? 'z-10 text-gray-300 fixed h-full right-0 top-0 w-[60%] border-r border-r-gray-900 bg-black/[.9] ease-in-out duration-500'
          : 'fixed right-[-100%]'
      "
    >
